...
* summary :
  ...
  3. untuk mengindetifikasi function dan method. prinsipnya di R, method adalah milik function sehingga dalam penulisannya akan selalu ''' functions "." method '''. contohnya :  mean.date() : mean : fungsi dan date : method/call
  
  4. kita bisa melihat semua method yang bisa dipanggil untuk fungsi yang dipakai dengan cara : methods('nama fungsi'). contoh : methods(mean)
